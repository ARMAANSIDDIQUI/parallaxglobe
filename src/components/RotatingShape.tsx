  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Core Glow */}
          <div className="absolute inset-0 bg-gradient-to-tr from-indigo-600 via-purple-600 to-emerald-400 rounded-full blur-[100px] opacity-30 animate-pulse" />
          
          {/* Abstract Sphere */}
          <div className="relative w-3/4 h-3/4 rounded-full bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-3xl border border-white/20 shadow-[inset_0_0_100px_rgba(255,255,255,0.1),0_0_40px_rgba(124,58,237,0.2)] flex items-center justify-center overflow-hidden">
            {/* Inner texture */}
            ...
            <motion.div 
              ...
              className="absolute w-3/5 h-3/5 bg-indigo-400/40 rounded-full blur-[50px]"
            />
          </div>
          ...
          <motion.div
            ...
            className="absolute inset-4 rounded-full border border-indigo-500/30 shadow-[0_0_20px_rgba(99,102,241,0.1)]"
            style={{ transformStyle: 'preserve-3d' }}
          />
          <motion.div
            animate={{ rotateY: -360, rotateZ: -360 }}
            transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
            className="absolute inset-8 rounded-full border border-purple-500/30 shadow-[0_0_20px_rgba(168,85,247,0.1)]"
            style={{ transformStyle: 'preserve-3d' }}
          />
        </motion.div>
      </motion.div>
